...
def search():
    ...
    search_bt = tk.Button(search_frame, text="Search", command=do_search)
    ...
    if file_path:
        with open(file_path, 'w') as file:
            for item in listbox.get(0, tk.END):
                file.write(f"{item}\n")
        messagebox.showinfo("Save List", "List saved !")
...
def load_list():
    ...
    if file_path:
        ...
        messagebox.showinfo("Load List", "List loaded !",)
...
insert_bt.pack(pady=5, padx=10, ipadx=22, ipady=5)
delete_bt.pack(pady=5, padx=10, ipadx=22, ipady=5)
undo_bt.pack(pady=5, padx=10, ipadx=22, ipady=5)
sort_bt.pack(pady=5, padx=10, ipadx=27, ipady=5)
search_bt.pack(pady=5, padx=10, ipadx=22, ipady=5)
exit_bt.pack(pady=5, padx=10, ipadx=28, ipady=5)
